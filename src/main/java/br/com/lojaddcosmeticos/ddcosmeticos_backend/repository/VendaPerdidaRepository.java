...
public interface VendaPerdidaRepository extends JpaRepository<VendaPerdida, Long> {
    ...
    // ✅ OTIMIZADO: Adicionamos Pageable caso haja muitos produtos procurados diferentes no futuro
    ...
    List<Object[]> countVendasPerdidasAgrupadasDesde(@Param("data") LocalDateTime data, Pageable pageable);
}